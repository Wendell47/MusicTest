...
export default function SongOptions({HideOnMobile=false,soundCloundId}){
    ...
    <SongChord className={`animation_slide_right ${HideOnMobile ? 'hideMobile': 'showOnMobile' }`}>
            ...
            {soundCloundId &&
               <iframe width="100%" height="166" scrolling="no" frameBorder="no" src={`https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/${soundCloundId}&amp;color=%23ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;show_teaser=true`}></iframe>
              }
            </div>
          </SongChord>
